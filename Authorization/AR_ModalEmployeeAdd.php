<div class="modal bg-body fade" tabindex="-1" id="kt_modal_add_user">
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_add_user" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                                <option value="1">2022 : พนักงานเริ่มเข้างานก่อน (30 มิถุนายน 2022)</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_add_user" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                                <option value="1">KPI : นับ KPI</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="First name" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input first name-->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="password" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="First name" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input first name-->
                                    </div>
