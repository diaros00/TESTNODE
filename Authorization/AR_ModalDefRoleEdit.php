<div class="modal fade" tabindex="-1" id="kt_modal_modify_role">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Modify Role : System</h5>
            ...
            <div class="modal-body">
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="code" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="CODE" value="System" />
                    <!--end::Input-->
                </div>
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="code" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NAME" value="System" />
                    <!--end::Input-->
                </div>
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control form-control-solid" placeholder="DESCRIPTION" id="floatingTextarea1" style="height: 200px">ผู้ดูแลระบบทั้งหมด</textarea>
                    </div>
                    <!--end::Input-->
                </div>
                <div class="fv-row mb-7">
                    ...
                    <!--begin::Input-->
                    <div class="form-floating">
                        <textarea class="form-control form-control-solid" placeholder="POLICY" id="floatingTextarea1" style="height: 200px">2 คน </textarea>
                    </div>
                    <!--end::Input-->
                </div>
                <div class="mb-3"></div>
                <div class="mb-5">
                    ...
                    <div class="form-check form-check-custom form-check-solid form-check-sm mb-5">
                        <input class="form-check-input" type="checkbox" value="" id="checkAll" checked='checked'/>
                    ...
                    <div class="d-flex fv-row">
                        ...
                        <div class="form-check form-check-custom form-check-solid form-check-lg">
                            <!--begin::Input-->
                            <input class="form-check-input me-3" name="checkItem" id="checkItem" type="checkbox" value="1" id="kt_modal_update_role_option_1" checked='checked' />
                            <!--end::Input-->
                            <!--begin::Label-->
                    ...
                    <div class="d-flex fv-row">
                        ...
                        <div class="form-check form-check-custom form-check-solid form-check-lg">
                            <!--begin::Input-->
                            <input class="form-check-input me-3" name="checkItem" id="checkItem" type="checkbox" value="2" id="kt_modal_update_role_option_2" checked='checked' />
                            <!--end::Input-->
                            <!--begin::Label-->
                    ...
                    <div class="d-flex fv-row">
                        ...
                        <div class="form-check form-check-custom form-check-solid form-check-lg">
                            <!--begin::Input-->
                            <input class="form-check-input me-3" name="checkItem" id="checkItem" type="checkbox" value="3" id="kt_modal_update_role_option_3" checked='checked' />
                            <!--end::Input-->
                            <!--begin::Label-->
                    ...
                    <div class="d-flex fv-row">
                        ...
                        <div class="form-check form-check-custom form-check-solid form-check-lg">
                            <!--begin::Input-->
                            <input class="form-check-input me-3" name="checkItem" id="checkItem" type="checkbox" value="4" id="flexCheckboxLg" checked='checked' />
                            <!--end::Input-->
                            <!--begin::Label-->
