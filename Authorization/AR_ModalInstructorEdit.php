<div class="modal bg-body fade" tabindex="-1" id="kt_modal_edit_instructor">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-200px">
                            ...
                            <li class="nav-item w-100">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_contact">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start">
                            ...
                            <li class="nav-item w-100">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_experiences">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start">
                            ...
                            <li class="nav-item w-100">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_education">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start">
                            ...
                            <li class="nav-item w-100">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_skills">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                            ...
                            <li class="nav-item w-100">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_quality">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start text-start">
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-10">
                        ...
                        <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row mb-8">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="First name TH" value="จารึก" />
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Lastname TH" value="แสงเพชร" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input Lastname-->
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Firstname ENG" value="Emma" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input first name-->
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Lastname ENG" value="Smith" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input Lastname-->
                                    </div>
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 200px">ฉันคือผู้เชียวชาญในด้านระบบการจัดการองค์กร ไม่ว่าจะเป็น ISO, IATF , 5S , QCC , KM ฯลฯ ซึ่งเป็นการเรียนรู้จากประสบการณ์ การลงมือท าจริง ตั้งแต่เป็น พนักงานระดับปฏิบัติการ จนไปเป็นผู้บริหาร จึงท าให้เห็นภาพ และจับต้องได้ รักในการสอนและบอกเล่าเรื่องราวความรู้ของตนเองให้ผู้อื่นฟัง ผ่านค าพูดง่ายๆ ลดความเป็นวิชาการ เพิ่มสัดส่วนตัวอย่างของความเป็นจริงเพื่อให้ผู้ฟังมีความ เข้าใจมากยิ่งขึ้น</textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                ...
                                <div class="row mb-8">
                                    <div class="col-sm-12 col-mb-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_edit_instructor" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_edit_instructor" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                                <option value="1" selected>Thai Summit Automotive Co., Ltd. (Headquarter)</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_edit_instructor" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                                <option value="H000000" selected>H000000 : TSH CENTER</option>
                            ...
                            <!-- begin::contact -->
                            <div class="tab-pane fade" id="tab_edit_contact" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="email" name="user_email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="012365@thaisummit.co.th" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--end::Input first name-->
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Phone" value="026632845" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input Lastname-->
                                    </div>
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 200px">101 Collin Street, Melbourne 3000 VIC Australia</textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                            ...
                            <!-- begin::experiences -->
                            <div class="tab-pane fade" id="tab_edit_experiences" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 200px">เริ่มทำงานวันที่ 1/5/2547 ตำแหน่งพนักงานปี 2547-2552 ตำแหน่งหัวหน้ากลุ่ม ปี 2553-2554 ตำแหน่งรักษาการหัวหน้าแผนกปี 2555-2561 ตำแหน่งหัวหน้าแผนกปี 2562-ปัจจุบัน </textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                            ...
                            <!-- begin::education -->
                            <div class="tab-pane fade" id="tab_edit_education" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2 font-Noto">Education level / วุฒิการศึกษาปัจจุบัน</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Education level" value="ปริญญาตรี" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input first name-->
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2 font-Noto">Major / สาขาการศึกษาปัจจุบัน</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="first_name" id="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Major" value="ครุศาสตร์เครื่องกล" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input Lastname-->
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <div class="form-floating">
                                            <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 200px">Scholarship : AOTS Japan to study in IT’s Engineering program at Yokohama, Japan, 2006 Bachelor’s Degree : Engineering Faculty on Kasetsart University
                                        </textarea>
                                        </div>
                                        <!--end::Input-->
                                    </div>
                            ...
                            <!-- begin::skills -->
                            <div class="tab-pane fade" id="tab_edit_skills" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="fw-semibold fs-6 mb-2 font-Noto">Performance / ผลงาน</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 100px">Training IT Product At NSTDA Academy, Microsoft, EGAT, CAT Telecom, ACIS,KBank etc.</textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="fw-semibold fs-6 mb-2 font-Noto">Expert skills / ทักษะชำนาญการ</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 100px">IT Consulting and Implement</textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="fw-semibold fs-6 mb-2 font-Noto">Certificate / ใบรับรอง</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="Address" id="floatingTextarea1" style="height: 100px">Microsoft Certified Solutions Associate</textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                            ...
                            <!-- begin::quality -->
                            <div class="tab-pane fade" id="tab_edit_quality" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <div class="form-floating">
                                                <textarea class="form-control form-control-solid" placeholder="My Quality Declaration" id="floatingTextarea1" style="height: 200px">Continuously improving supply chain performance and processes to achieve the best results</textarea>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
