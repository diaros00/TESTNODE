                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="alert alert-dismissible border d-flex flex-column flex-sm-row p-5 mb-10"
                                ...
                                <!--begin::Icon-->
                                <h4 class="fw-semibold me-4 mb-5 mb-sm-0 fs-3x text-dark">Filter News</h4>
                                <!--end::Icon-->
                                <!--begin::Wrapper-->
                                <div class="d-flex flex-column pe-0 pe-sm-5">
                                    ...
                                    <select class="form-select w-lg-300px" aria-label="Select example">
                                        ...
                                        <option value="1">COURSE : หลักสูตร</option>
                                        <option value="2">PUBLIC RELATION : ประชาสัมพันธ์</option>
                                        <option value="3">VISION : นโยบาย</option>
                                    </select>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-lg-10">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                ...
                                                <div class="menu-item px-3 fs-5">
                                                    <a href="News/NS_Search.php?view=list" class="menu-link px-3">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3 fs-5">
                                                    <a href="News/NS_Search.php?view=card" class="menu-link px-3"><i
                                    ...
                                    if($view == 'list'){
                                        include 'NS_SearchList.php';
                                    }elseif($view == 'card'){
                                        include 'NS_SearchCard.php';
                                    }else{
                                        include 'NS_SearchList.php';
                                    }
