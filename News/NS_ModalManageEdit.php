<div class="modal bg-body fade" tabindex="-1" id="kt_modal_edit_news">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content shadow-none">
            <div class="modal-header">
                <h5 class="modal-title">Edit Account : Bootstrap Admin - How To Get Started Tutorial</h5>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-200px">
                            <li class="nav-item w-100 me-0 mb-md-2">
                                <a class="nav-link w-100 active btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_info">
                            ...
                            <li class="nav-item w-100 me-0 mb-md-2">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_multimedia">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start">
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-10">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <!-- begin::Profile -->
                            <div class="tab-pane fade show active" id="tab_edit_info" role="tabpanel">
                                ...
                                <div class="row mb-8">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="title_news" id="title_news" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="TITLE NEWS" value="Bootstrap Admin - How To Get Started Tutorial. Create a customizable SaaS Based applications and solutions" />
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select onchange="showCourseDiv(this)" class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_edit_news" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                                <option value="public" selected>ประชาสัมพันธ์</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="fv-row mb-7" id="div_course" style="display:none;">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_edit_news" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="py-5" data-bs-theme="light">
                                                <textarea name="detailEditNews" id="detailEditNews">
                                                    <h1>หัวข่าวเรื่อง</h1>
                                                    <p>เนื้อหา</p>
                                                    <h1>หัวข้อวิดีโอ</h1>
                                                    <figure class="symbol">
                            ...
                            <!-- begin::multimedia -->
                            <div class="tab-pane fade" id="tab_edit_multimedia" role="tabpanel">
