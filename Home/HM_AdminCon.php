...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                    ...
                                    <div class="w-100 flex-lg-row-fluid mx-lg-13">
                                        ...
                                        <div class="card card-flush mb-10 gradient-while">
                                            ...
                                            <div class="card-header justify-content-center align-items-center pt-4 text-center">
                                                <!--begin::Illustration-->
                                                <img src="assets/media/icons/canvas/IC-Home-Award.png" class="h-200px me-15 animate__animated animate__rubberBand" alt="" />
                                                <!--end::Illustration-->
                                                <h1 class="text-gray-900 font-weight-boldest">CONGRATULATIONS! </h1>
                                            </div>
                                            <!--end::Header-->
                                            <!--begin::Body-->
                                            <div class="card-body pt-2 pb-0 text-center">
                                                <!--begin::Input-->
                                                <p class="text-gray-700 font-weight-light">ขอแสดงความยินดีคุณได้ผ่าน<br>การอบรมของ TS ACADEMY ของปีนี้</p>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Body-->
                                        </div>
                                        ...
                                        <div class="card card-flush mb-10 pt-5 px-5 py-5">
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <!--begin::Title-->
                                                <div class="m-0">
                                                    <a href="Course/CO_Train.php?category=Assessment&status=Fail" class="text-warning fw-bold text-hover-primary fs-6"><i class="fa-solid fa-circle-exclamation text-warning me-1 fs-3 animate__animated animate__fadeIn animate__infinite"></i> Basic Cutting Tool & Drill<br>
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <!--begin::Title-->
                                                <div class="m-0">
                                                    <a href="Course/CO_Train.php?category=PostTest&status=Fail" class="text-warning fw-bold text-hover-primary fs-6"><i class="fa-solid fa-circle-exclamation text-warning me-1 fs-3 animate__animated animate__fadeIn animate__infinite"></i> Pneumatic Systems (for Die Casting)<br>
                                                        <o class="text-gray-600 fw-semibold">Core Competency</o><br>
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <!--begin::Title-->
                                                <div class="m-0">
                                                    <a href="Course/CO_Detail.php" class="text-gray-900 fw-bold text-hover-primary fs-6">การใช้งานหุ่นยนต์ในอุตสาหกรรมชิ้นส่วนยานยนต์<br>
                                                        <o class="text-gray-600 fw-semibold">Core Competency</o><br>
                                                    </a>
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <!--begin::Title-->
                                                <div class="m-0">
                                                    <a href="Course/CO_Train.php?category=Wait" class="text-gray-900 fw-bold text-hover-primary fs-6">Hydraulic Systems (for Die Casting)<br>
                                                        <o class="text-gray-600 fw-semibold">Core Competency</o><br>
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <!--begin::Title-->
                                                <div class="m-0">
                                                    <a href="Course/CO_Train.php?category=Complete" class="text-success fw-bold text-hover-primary fs-6"><i class="fa-solid fa-circle-check me-2 fs-3 text-success"></i>New Dies purchasing standard<br>
                                                        <o class="text-gray-600 fw-semibold">Core Competency</o><br>
    ...
    <script>
        var congratulation = true;
    </script>
    <script src="Home/HM_Admin.js"></script>
