							...
							<div id="carouselExampleCaptions" class="carousel slide animate__animated animate__fadeIn" data-bs-ride="carousel">
								...
								<div class="carousel-inner">
									<div class="carousel-item active ">
										<center>
											<img src="assets/media/stock/900x600/1.jpg" class="d-block w-100" alt="...">
										</center>
									</div>
									<div class="carousel-item">
										<center>
											<img src="assets/media/stock/900x600/2.jpg" class="d-block w-100" alt="...">
										</center>
									</div>
									<div class="carousel-item">
										<center>
											<img src="assets/media/stock/900x600/3.jpg" class="d-block w-100" alt="...">
										</center>
									</div>
									<div class="carousel-item">
										<center>
											<img src="assets/media/stock/900x600/4.jpg" class="d-block w-100" alt="...">
										</center>
									</div>
								</div>
									...
									<div class="card-px text-center pt-15 pb-15">
										...
										<span class="ms-3 d-inline-flex position-relative text-dark">
											<h1 class="fs-5x fw-bold mb-0">
												<font color"#058619">T</font>
												<font color"#FE7900">S</font> ACADEMY
											</h1>
							...
							<div id="kt_app_content_container" class="app-container container-xxl">
								<div class="card" style="background-color: #080655">
									...
									<div class="card-body">
												...
												<div class="col-lg-4 col-sm-6 hover-elevate-up">
													<div class="symbol symbol-200px symbol-circle overlay overflow-hidden">
														<div class="card-body p-0">
															<div class="symbol-label overlay-wrapper" style="background-image:url(assets/media/avatars/300-5.jpg)">
															</div>
															<div class="overlay-layer bg-dark bg-opacity-25 hover-scale">
																<a href="Instructor/IT_InstructorProfile.php" class="btn btn-icon btn-secondary"><i class="ki-duotone ki-profile-circle fs-2x text-primary">
										...
										<!--end::Heading-->
										<!--begin::Illustration-->
										<center><a href="Instructor/IT_Instructor.php" class="btn btn-outline btn-outline-dashed btn-outline-primary btn-active-light-primary text-center hover-scale btn-lg fs-1x">VIEW
												ALL</a>
										</center>
										<!--end::Illustration-->
									</div>
