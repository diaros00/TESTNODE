                        ...
                        <div class="d-flex flex-row-auto flex-end">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-dark btn-flex h-50px border-0 fw-bold px-4 px-lg-6"
                                    href="Masterdata/MS_InstructorSearch.php">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                    ...
                                    <div class="menu-item px-3 fs-5">
                                        <a href="Masterdata/MS_InstructorSearch.php?view=list" class="menu-link px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3 fs-5">
                                        <a href="Masterdata/MS_InstructorSearch.php?view=card" class="menu-link px-3"><i
