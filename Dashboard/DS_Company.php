                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('assets/media/svg/shapes/top-department.png" data-bs-theme="light">
                                                ...
                                                <h3 class="card-title align-items-start flex-column text-white pt-15">
                                                    <span class="fw-bold fs-2x mb-3 text-dark">My Company</span>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                                ...
                                                                <div class="m-0">
                                                                    ...
                                                                    <!--end::Number-->
                                                                    <!--begin::Desc-->
                                                                    <span class="text-gray-500 fw-semibold fs-6">Company Result</span>
                                                                    <!--end::Desc-->
                                                                </div>
                                                                <!--end::Stats-->
                                                            </div>
                                    ...
                                    <div class="col-xl-8 mb-5 mb-xl-10">
                                        ...
                                        <div class="card border-transparent mb-5 gradient-while" data-bs-theme="light">
                                            ...
                                            <div class="card-body d-flex">
                                                ...
                                                <div class="m-0 mb-15">
                                                    <!--begin::Title-->
                                                    <div class="position-relative fs-2x z-index-2 fw-bold text-gray-900 mb-7">
                                                        <div class="mb-15"></div>
                                                        <div class="mb-sm-15"></div>
                                                        <span class="me-2">Dashboard of company<br>
                                                            <span class="position-relative d-inline-block text-danger">
                                                                <div class="text-danger">Thaisummit-harness</div>
                                                                <!--begin::Separator-->
                                                                <span class="position-absolute opacity-50 bottom-0 start-0 border-4 border-danger border-bottom w-100"></span>
                                                                <!--end::Separator-->
                                                            </span></span>
                                                        <br />
                                                        <o class="font-Noto fs-3 text-gray-700">ภาพรวมทั้งหมดสำหรับโรงงาน</o>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                                <!--begin::Wrapper-->
                                                <!--begin::Illustration-->
                                                <img src="assets/media/icons/canvas/IC-DS-company.png" class="position-absolute me-3 bottom-0 end-0 h-150px h-lg-300px animate__animated animate__pulse" alt="" />
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Body-->
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="position-relative fs-2x fw-bold text-gray-700 mb-9 animate__animated animate__fadeInLeft">
                                                            <div class="mb-15"></div>
                                                            <div class="mb-sm-15"></div>
                                                            <span class="me-2" style="background: linear-gradient(to right, #1488CC , #2B32B2);-webkit-text-fill-color: transparent;-webkit-background-clip: text;">TOTAL PROGRESS TRINING <br>OF COMPANY</span>
                                                        </div>
                                                        <!--end::Wrapper-->
                                                    </div>
                                                    <!--end::Col-->
                                        ...
                                        <div class="card h-xl-100">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-900">Progress training of company</span>
