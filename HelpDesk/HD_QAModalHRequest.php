            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_ticket_form" class="form" action="#">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Create Request Help</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-gray-500 fw-semibold fs-5 font-Noto">ถามหรือขอความช่วยเหลือกับ
                            <o class="fw-bold link-primary">TS ACADEMY</o> เราสิ</div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    ...
                    <div class="row g-9 mb-8 font-Noto">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Open"
