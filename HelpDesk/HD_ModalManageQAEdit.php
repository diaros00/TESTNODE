...
<div class="modal fade" id="modal_manageqa_edit" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="modal_manageqa_edit_form" class="form" action="#">
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Edit Question Q&A : ระบบ Academy คืออะไร ?</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-gray-500 fw-semibold fs-5 font-Noto">แก้ไขคำถามสำหรับ Q&A</div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row font-Noto">
                        ...
                        <input type="text" class="form-control form-control-solid"
                            placeholder="Enter subject" name="subject" value="ระบบ Academy คืออะไร ?" />
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="row g-9 mb-8 font-Noto">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Category"
                                ...
                                <option value="4" selected>คำถามยอดฮิต</option>
                            </select>
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row font-Noto">
                        ...
                        <textarea class="form-control form-control-solid" rows="4" name="description"
                            placeholder="Detail question description">First, a disclaimer – the entire process of writing a blog post often takes more than a couple of hours, even if you can type eighty words as per minute and your writing skills are sharp.
                        </textarea>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
