<div class="modal bg-body fade" tabindex="-1" id="modal_class_edit">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content shadow-none">
            <div class="modal-header">
                <h5 class="modal-title">Edit CLASS TRAIN : 1/TSH</h5>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-200px">
                            <li class="nav-item w-100 me-0 mb-md-2">
                                <a class="nav-link w-100 active btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_information">
                            ...
                            <li class="nav-item w-100 me-0 mb-md-2">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_schedule">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start">
                            ...
                            <li class="nav-item w-100 me-0 mb-md-2">
                                <a class="nav-link w-100 btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#tab_edit_expenses">
                                    <span class="svg-icon fs-2"><svg>...</svg></span>
                                    <span class="d-flex flex-column align-items-start">
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-10">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <!-- begin::Information -->
                            <div class="tab-pane fade show active" id="tab_edit_information" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <!--end::Label-->
                                            <input type="number" class="form-control form-control-solid" placeholder="CLASS NUMBER" value="1" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-8">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <select class="form-select form-select-solid" aria-label="Select example">
                                                ...
                                                <option value="1" selected>ภายใน</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <select class="form-select form-select-solid" aria-label="Select example">
                                                ...
                                                <option value="4" selected>Hybrid - อบรมในรูปแบบ Calassroom และ Online</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <select class="form-select form-select-solid" aria-label="Select example">
                                                ...
                                                <option value="1" selected>โควต้า</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <!--end::Label-->
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#modal_class_edit" data-placeholder="Select an option" data-allow-clear="true">
                                                <option></option>
                                                ...
                                                <option value="11" selected>สมรักษ์ สุขมาหา</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <textarea name="description_edit" id="description_edit">
                                                <p>หลักสูตรนี้เป็นส่วนหนึ่งของในกลุ่มบริษัทไทยซัมมิท</p>
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- end::Information -->
                            <!-- begin::Information -->
                            <div class="tab-pane fade" id="tab_edit_schedule" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <!--end::Label-->
                                            <input type="number" class="form-control form-control-solid" placeholder="NUMBER OR PARTICIPANT" value="30" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-8">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            <!--begin::Label-->
                                            <label for="register_start_edit_input" class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                <span class="required">BEGIN ENROLL DATETIME / เริ่มเปิดให้ลงทะเบียน</span>
                                            </label>
                                            <!--end::Label-->
                                            <div class="input-group log-event" id="register_start_edit" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                <input id="register_start_edit_input" type="text" class="form-control form-select-solid" data-td-target="#register_start_edit" value="01/25/2024 8:00 AM" />
                                                <span class="input-group-text" data-td-target="#register_start_edit" data-td-toggle="datetimepicker">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            <!--begin::Label-->
                                            <label for="register_end_edit_input" class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                <span class="required">END ENROLL DATETIME / สิ้นสุดให้ลงทะเบียน</span>
                                            </label>
                                            <!--end::Label-->
                                            <div class="input-group log-event" id="register_end_edit" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                <input id="register_end_edit_input" type="text" class="form-control form-select-solid" data-td-target="#register_end_edit" value="01/25/2024 9:00 AM" />
                                                <span class="input-group-text" data-td-target="#register_end_edit" data-td-toggle="datetimepicker">
                                                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span class="path2"></span></i>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <!--end::Label-->
                                            <div class="input-group log-event" id="class_start_edit" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                <input id="class_start_edit_input" type="text" class="form-control form-select-solid" data-td-target="#class_start_edit" value="01/25/2024 8:00 AM" />
                                                <span class="input-group-text" data-td-target="#class_start_edit" data-td-toggle="datetimepicker">
                                                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span class="path2"></span></i>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <!--end::Label-->
                                            <div class="input-group log-event" id="class_end_edit" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                <input id="class_end_edit_input" type="text" class="form-control form-select-solid" data-td-target="#class_end_edit" value="01/25/2024 5:00 PM" />
                                                <span class="input-group-text" data-td-target="#class_end_edit" data-td-toggle="datetimepicker">
                                                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span class="path2"></span></i>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <!--end::Label-->
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#modal_class_edit" data-placeholder="Select an option">
                                                <option></option>
                                                <option value="1" selected>TSA : Thai Summit Auto Press Co, Ltd.</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#modal_class_edit" data-placeholder="Select an option">
                                                <option></option>
                                                <option value="2" selected>TS ACADEMY</option>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option">
                                                <option></option>
                                                <option value="1" selected>Theater</option>
                            ...
                            <!-- end::Information -->
                            <!-- begin::Information -->
                            <div class="tab-pane fade" id="tab_edit_expenses" role="tabpanel">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="d-flex flex-column mb-8 fv-row font-Noto">
                                            ...
                                            <div class="input-group input-group-solid mb-5">
                                                ...
                                                <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="300"/>
