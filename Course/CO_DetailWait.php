                            ...
                            <div class="d-flex flex-column flex-xl-row">
                                ...
                                <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                                    ...
                                    <div class="card card-flush bg-body card-p-2 border-3 border-dotted shadow-1 mb-9 border-gray-500 p-5">
                                        <!--begin::Card header-->
                                        <div class="mb-6"></div>
                                        <i class="fa-solid fa-clock text-gray-500 fs-5x text-center"></i>
                                        <h1 class="card-title fs-2x fw-bold text-gray-500 text-center mb-6">รอกำหนดการ
                                        </h1>
                                        <h4 class="card-title fw-bold text-gray-900 text-center mb-6">ขณะนี้ยังไม่เปิดการลงทะเบียน
                                        </h4>
                                    </div>
                                    <!--end::Follower class-->
                                    <!--begin::Catigories-->
                                    <div class="card card-flush bg-body card-p-2 border-3 shadow-1 mb-9">
                                        ...
                                        <div class="card-header card-p-2">
                                            <h4 class="card-title fw-bold text-gray-900">รุ่นอบรมทั้งหมด 4
                                            </h4>
                                        ...
                                        <div class="card-body pt-1 font-Noto">
                                            ...
                                            <div class="d-flex flex-stack fw-semibold fs-3 text-gray-500 mb-4">
                                                ...
                                                <div class="text-gray-900 pe-2">รุ่นที่ 1<br>
                                                    <o class="fs-6 text-gray-500"><i class="fa-solid fa-calendar-days me-2 fs-6"></i> วันที่ 10/10/2023 <br> เวลา 08.00</o>

                                                </div>
                                                <!--end::Number class-->
                                                <!--begin::Status Calss-->
                                                <div class="m-0 text-center"><span class="badge badge-dark font-Noto fs-6">รอกำหนดการ</span><br>
                                                    <o class="text-gray-900"><i class="fa-solid fa-users text-gray-900"></i> 40 คน</o>
                                                </div>
                                                <!--end::Status Calss-->
                                            </div>
                                            <div class="m-0 text-end fs-5">0/40 คน</div>
                                            <div class="progress mb-8" style="height: 8px;">
                                                <div class="progress-bar bg-dark" role="progressbar" style="width: 0%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            <!--end::Item-->
                                            <div class="separator border-gray-400 mb-12"></div>
                                            <!--begin::Item-->
