                                ...
                                <div id="kt_user_profile_nav" class="rounded bg-gray-200 d-flex flex-stack flex-wrap mb-9 p-2" data-kt-sticky="true" data-kt-sticky-name="sticky-profile-navs" data-kt-sticky-offset="{default: false, lg: '400px'}" data-kt-sticky-width="{target: '#kt_user_profile_panel'}" data-kt-sticky-left="auto" data-kt-sticky-top="70px" data-kt-sticky-animation="true" data-kt-sticky-zindex="95">
                                    ...
                                    <ul class="nav flex-wrap border-transparent">
										...
										<li class="nav-item my-1">
											<a class="btn btn-sm btn-color-gray-600 bg-state-body btn-active-color-gray-800 fw-bolder fw-bold fs-7 fs-lg-3 fs-lg-base nav-link px-3 px-lg-4 mx-1" href="Course/CO_Profile.php">My Enrolled Courses<br>
										...
										<!--begin::Nav item-->
										<li class="nav-item my-1">
											<a class="btn btn-sm btn-color-gray-600 bg-state-body btn-active-color-gray-800 fw-bolder fw-bold fs-7 fs-lg-3 fs-lg-base nav-link px-3 px-lg-4 mx-1 active" href="Course/CO_ProReport.php">Grade report<br>
                                ...
                                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                    ...
                                    <div class="card-header cursor-pointer">
                                        ...
                                        <div class="card-title m-0">
                                            <h3 class="fw-bold m-0">ทั้งหมด 3 หลักสูตร</h3>
                                        </div>
                                        <!--begin::Card title-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0 font-weight-light" id="table_report_grade">
                                                <thead>
                                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-1px text-center text-gray-800">ก่อนอบรม<br>5
                                                        </th>
                                                        <th class="min-w-1px text-center text-gray-800">หลังอบรม<br>5
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody class="fw-semibold text-gray-600">
                                                    <tr>
                                                        ...
                                                        <td class="text-dark fs-6 font-Noto">MC-SS-01 Effective
                                                            ...
                                                            (สื่อสารสร้างสัมพันธ์ชั้นเลิศด้วยเทคนิค NLP)</td>
                                                        <td class="text-dark fs-6 text-gray-600 font-Noto text-center">2
                                                        </td>
                                                        <td class="text-dark fs-6 font-Noto text-center">3
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-dark fs-6 font-Noto text-center">2</td>
                                                        <td class="text-dark fs-6 font-Noto">CC-ST-01
                                                            ความปลอดภัยในการทำงาน และการจำลองอุบัติเหตุ (Safety DOJO)
                                                        </td>
                                                        <td class="text-dark fs-6 text-gray-600 font-Noto text-center">2
                                                        </td>
                                                        <td class="text-dark fs-6 font-Noto text-center">4
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-dark fs-6 font-Noto text-center">3</td>
                                                        <td class="text-dark fs-6 font-Noto">ENC-BE-01 Advance Product
                                                            Quality Planning : APQP</td>
                                                        <td class="text-dark fs-6 text-gray-600 font-Noto text-center">2
                                                        </td>
                                                        <td class="text-dark fs-6 font-Noto text-center">4
                                                        </td>
