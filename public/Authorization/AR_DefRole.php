						...
						<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-8">
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center me-3">
									<!--begin::Title-->
									<h1 class="page-heading d-flex text fw-bold fs-2x flex-column justify-content-center my-0">List of Define roles</h1>
									<!--end::Title-->
									<span class="font-Noto text-gray-600 fs-5">การจัดการสิทธิการเข้าใช้ระบบ</span>
								</div>
								<!--end::Page title-->
								<!--begin::Actions-->
								<div class="d-flex align-items-center">
									<a href="#" class="btn btn-icon btn-primary w-200px h-55px" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">
										<i class="fa-solid fa-user-plus me-1 fs-5"></i>Add a new define roles
									</a>
								...
								<div class="card">
									...
									<div class="card-body pt-0">
										...
										<div class="table-responsive">
											<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_defrole_table">
												<thead>
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">System</td>
														...
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																...
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item text-gray-700 fs-5" href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_modify_role"><i class="fa-solid fa-pen-to-square me-2 text-gray-700 fs-3"></i>Modify Role</a></li>
													...
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">Admin TS ACADEMY</td>
														<td class="text-success"><span class="badge badge-light-success fs-5">Enabled</span></td>
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																<div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
													...
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">Manager TS ACADEMY</td>
														<td class="text-success"><span class="badge badge-light-success fs-5">Enabled</span></td>
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																<div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
													...
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">Admin Department</td>
														<td class="text-success"><span class="badge badge-light-success fs-5">Enabled</span></td>
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																<div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
													...
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">Manager</td>
														<td class="text-dark"><span class="badge badge-light-dark fs-5">Disable</span></td>
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																<div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
																	<i class="fa-solid fa-eye me-1"></i>View
													...
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">User</td>
														<td class="text-dark"><span class="badge badge-light-dark fs-5">Disable</span></td>
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																<div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
													...
													<tr>
														...
														<td class="text-primary fs-3 font-Noto">Viewer</td>
														<td class="text-dark"><span class="badge badge-light-dark fs-5">Disable</span></td>
														<td class="text-end">
															<div class="btn btn-primary btn-sm btn-group" role="group">
																<div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
