...
"use strict";
var TableManageNews = (function () {
  var t, e;
  return {
    init: function () {
      (e = document.querySelector("#kt_manage_news_table")) &&
...
KTUtil.onDOMContentLoaded(function () {
  TableManageNews.init();
});

ClassicEditor
    .create(document.querySelector('#detailNews'))
    .then(editor => {
        console.log(editor);
    })
    .catch(error => {
    ...
    ClassicEditor
    .create(document.querySelector('#detailEditNews'))
    .then(editor => {
        console.log(editor);
    })
    .catch(error => {
