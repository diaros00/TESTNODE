                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">Enroll</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="flex-lg-row-fluid font-Noto">
                                    ...
                                    <div class="stepper-wrapper mb-3">
                                        <div class="stepper-item active">
                                            <div class="step-counter"><i class="fa-solid fa-file-pen fs-3 text-white"></i></div>
                                            <div class="step-name">
                                                ...
                                                <div class="timeline timeline-border-dashed">
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-icon bg-warning">
                                                            <i class="fa-solid fa-file-pen fs-3 text-white">
                                                            </i>
                                                        </div>
                                                        <!--end::Timeline icon-->
                                                        ...
                                                        <div class="timeline-content mb-10 mt-n1">
                                                            ...
                                                            <div class="pe-3 mb-5">
                                                                ...
                                                                <div class="d-flex align-items-center mt-1 fs-6">
                                                                    <!--begin::Info-->
                                                                    <div class="text-muted me-2 fs-7">Created at <o class="text-primary">-</o>
                                                                    </div>
                                                                    <!--end::Info-->
                                                                </div>
                                                                <!--end::Created at-->
                                    ...
                                    <div class="mb-17">
                                        ...
                                        <div class="p-0">
                                            ...
                                            <div class="fs-5 fw-semibold text-gray-600 mt-4">
                                                ...
                                                <!--end::Text-->
                                                <!--begin::select class-->
                                                <select class="form-select mb-8" data-control="select2" data-placeholder="Selec Training Class">
                                                    <option></option>
                                                        ...
                                                        <div id="kt_accordion_1_body_2" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_2" data-bs-parent="#kt_accordion_1">
                                                            <div class="accordion-body">
                                                                ...
                                                                <select class="form-select form-select-lg form-select-solid mb-8" data-control="select2" data-placeholder="Select employee" data-allow-clear="true" multiple="multiple">
                                                                    <option></option>
                                                                    <option value="1" selected="selected">00001 : อำพร ใจศรีเมือง</option>
                                                                    <option value="2" selected="selected">00002 : สุชาณี มากทอง</option>
                                                                    <option value="2" selected="selected">00003 : สายชล วงสุวรรค</option>
                                                                    ...
                                                                    <div class="input-group flex-nowrap">
                                                                        ...
                                                                        <div class="overflow-hidden flex-grow-1">
                                                                            <select class="form-select  rounded-start-0" data-control="select2" data-close-on-select="false" data-placeholder="Select manager department" data-allow-clear="true">
                                                                                <option></option>
                                                                                <option value="1" selected="selected">00002 : สมรักษ์ มีทองเงิน</option>
                                ...
                                <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                                    ...
                                    <div class="card card-flush bg-body card-p-2 border-3 border-dotted shadow-1 mb-9 border-primary p-5">
                                        ...
                                        <h4 class="card-title fw-bold text-gray-900 text-center mb-6">
                                            คลิกเพื่อแก้ไขข้อมูลและทำการรายถัดไป
                                        </h4>
                                        ...
                                        <!--end::Card body-->
                                        <!--begin::Card body-->
                                        <a href="#" class="btn btn-danger btn-lg mb-5 hover-scale card-p-2" style="font-family: 'Noto Sans Thai', sans-serif;">ยกเลิกลงทะเบียน</a>
                                        <!--end::Card body-->
