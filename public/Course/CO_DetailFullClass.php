                            ...
                            <div class="d-flex flex-column flex-xl-row">
                                ...
                                <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                                    ...
                                    <div class="card card-flush bg-body card-p-2 border-3 border-dotted shadow-1 mb-9 border-danger p-5">
                                        <!--begin::Card header-->
                                        <div class="mb-6"></div>
                                        <h4 class="card-title fw-bold text-gray-900 text-center mb-6">ขออภัยไม่สามารถลงทะเบียนได้
                                        </h4>
                                        <h1 class="card-title fs-3x fw-bold text-danger text-center mb-6">เต็ม!
                                        </h1>
                                    </div>
                                    <!--end::Follower class-->
                                    <!--begin::Follower class-->
