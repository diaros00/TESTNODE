                                ...
                                <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                                    ...
                                    <div class="card card-flush bg-body card-p-2 border-3 border-dotted shadow-1 mb-9 border-primary p-5 ">
                                        ...
                                        <h2 class="card-title text-gray-500 text-center fs-4 mb-6">
                                            <i class="fa-solid fa-location-dot fw-bold text-danger fs-4x mb-2 animate__animated animate__bounceIn"></i><br>
                                            <o class="fw-light text-primary">CHECK-IN</o>
                                        </h2>
                                        ...
                                        <!--end::Card header-->
                                        <!--begin::Card body-->
                                        <a href="Course/CO_Train.php?category=PreTest" class="btn btn-primary btn-lg mb-5 hover-scale card-p-2" style="font-family: 'Noto Sans Thai', sans-serif;">Check-IN เข้าอบรม</a>
                                        <!--end::Card body-->
                                    </div>
                                    <!--end::Follower class-->
                                </div>
