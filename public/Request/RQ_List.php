                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                <!--begin::Hearder-->
                                <?php
                                $tilte = "รายการยื่นอนุมัติ (List request)";
                                $listpage = "active";
                                $listapprove = "";
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-title fs-3 fw-bold font-Noto title-total">คำสั่งยื่นขออนุมัติ ทั้งหมด 6 รายการ
                                        </div>
                                                ...
                                                <div class="d-flex align-items-center position-relative my-1 me-5 ">
                                                    ...
                                                    <div class="btn btn-primary btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <span class="fs-8 text-gray-500 mb-3">
                                                                <o class="me-3"></o>ACTION
                                                            </span>
                                                            <li><a class="dropdown-item text-gray-700 fs-5" href="Reports/RP_Individual.php"><i class="fa-solid fa-trash-can me-2 text-danger fs-3"></i>DELETE FORM</a></li>
                                                            <div class="separator mb-3"></div>
                                                            <span class="fs-8 text-gray-500">
                                                                <o class="me-3"></o>FORM
                                                            </span>
                                                            <li><a class="dropdown-item text-gray-700 fs-5" href="Reports/RP_Profile.php"><i class="fa-solid fa-circle-check me-2 text-success fs-3"></i>CANCEL FORM</a></li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <table id="datatable_my_request" class="table table-striped table-row-bordered gy-5 gs-7">
                                                <thead>
                                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-150px max-w-200px text-center text-gray-800">Current Approver<br>ผู้อนุมัติปัจจุบัน
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="cursor-pointer">
                                                        ...
                                                        <td class="text-dark fs-6 font-Noto">ขออนุมัติเปิดหลักสูตรลงทะเบียน คิดอย่างเป็นระบบ<br>
                                                            <o class="fs-6 text-primary">ผู้ดำเนินการ : สมศักดิ์ มากเงิน</o>
                                                        </td>
                                                        <td class="fs-6 text-info font-Noto text-center fw-bold">
                                                            หลักสูตร
                                                        </td>
                                                    ...
                                                    <tr class="cursor-pointer">
                                                        ...
                                                        <td class="text-dark fs-6 font-Noto">ขออนุมัติเปิดรุ่นหลักสูตรลงทะเบียน คิดอย่างเป็นระบบ<br>
                                                            <o class="fs-6 text-primary">ผู้ดำเนินการ : สมศักดิ์ มากเงิน</o>
                                                        </td>
                                                        <td class="fs-6 text-info font-Noto text-center fw-bold">
                                                            หลักสูตร
                                                    ...
                                                    <tr class="cursor-pointer">
                                                        ...
                                                        <td class="text-dark fs-6 font-Noto">ขออนุมัติปิดหลักสูตร คิดอย่างเป็นระบบ<br>
                                                            <o class="fs-6 text-primary">ผู้ดำเนินการ : สมศักดิ์ มากเงิน</o>
                                                        </td>
                                                        <td class="fs-6 text-info font-Noto text-center fw-bold">
                                                            หลักสูตร
                                                    ...
                                                    <tr class="cursor-pointer">
                                                        ...
                                                        <td class="text-dark fs-6 font-Noto">ขออนุมัติสิทธิใช้งานระบบ ส่วนเจ้าหน้าที่ Admin<br>
                                                            <o class="fs-6 text-primary">ผู้ดำเนินการ : สมศักดิ์ มากเงิน</o>
                                                        </td>
                                                        <td class="fs-6 text-info font-Noto text-center fw-bold">
                                                            สิทธิใช้งานระบบ
                                                    ...
                                                    <tr class="cursor-pointer">
                                                        ...
                                                        <td class="text-dark fs-6 text-gray-600 font-Noto">
                                                            <i class="fa-solid fa-circle text-danger fs-12 me-1"></i>
                                                            <o>สมรักษ์ มีทองเงิน</o><br>
                                                            <o class="text-gray-500 fs-7">Manager </o>
                                                        </td>
