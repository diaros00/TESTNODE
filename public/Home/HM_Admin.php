                                            ...
                                            <div id="kt_carousel_3_carousel" class="carousel carousel-custom slide" data-bs-ride="carousel" data-bs-interval="10000">
                                                ...
                                                <div class="carousel-inner pt-8">
                                                    ...
                                                    <div class="carousel-item active">
                                                        ...
                                                        <h3 class="font-size-h1 font-weight-bolder text-hover-primary cursor-pointer" onclick="location.href='News/NS_Post.php'">Bootstrap Admin -How To Get Started Tutorial.</h3>
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="Request/RQ_Approve.php" class="menu-link px-3">Approve list</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="Request/RQ_List.php" class="menu-link px-3">Request list</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="Request/RQ_From.php" class="menu-link px-3">Request from</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu separator-->
