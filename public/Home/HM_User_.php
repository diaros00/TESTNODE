                                            ...
                                            <div class="row">
                                                <div class="col-4 text-center">
                                                    <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                                        <!--begin::Avatar-->
                                                        <a href="Masterdata/MS_InstructorProfile.php" class="symbol symbol-100px symbol-circle mb-5">
                                                        ...
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                        <a href="Masterdata/MS_InstructorProfile.php" class="fs-6 text-gray-800 text-hover-primary fw-bold mb-0">Patric Watson</a>
                                                        <!--end::Name-->
                                                        <!--begin::course-->
