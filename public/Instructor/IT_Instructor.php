              ...
              <div class="card-body"
                ...
                <div class="card-px text-center pt-15 pb-15">
                  ...
                  <h2 class="fs-4x fw-bold mb-0 text-center text-gray-200">
                    <o class="animate__animated animate__fadeInUp">วิทยากรชั้นนำ<br>ของพวกเรา<br></o>
                    <span class="ms-3 d-inline-flex position-relative">
                      <o class="fs-2x text-danger animate__animated animate__fadeIn animate__slow	">Our Expert Instructor</o>
                      <img class="w-100 position-absolute bottom-0 mb-n2 animate__animated animate__fadeIn animate__slow	"
                  ...
                  <div class="boira-ourwork-img-cont wrapper">
                    <div class="marquee animate__animated animate__fadeIn animate__slower">
                          ...
                          <div class="symbol symbol-100px symbol-circle overlay overflow-hidden">
                            <div class="card-body p-0">
                              ...
                              <div class="overlay-layer bg-dark bg-opacity-25 hover-scale">
                                <a href="Instructor/IT_InstructorProfile.php" class="btn btn-icon btn-secondary"><i
                    ...
                    <div class="main-wrapper animate__animated animate__fadeIn animate__slower">
          ...
          <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="d-flex flex-row-auto flex-end">
              <div class="d-flex align-items-center">
                ...
                <!--begin::Preview link-->
                <a class="btn btn-dark btn-flex h-50px border-0 fw-bold px-4 px-lg-6" href="Instructor/IT_InstructorSearch.php">
              ...
              <div class="card-toolbar">
                ...
                <div
                  ...
                  <div class="menu-item px-3 fs-5">
                    <a href="Instructor/IT_Instructor.php?view=list" class="menu-link px-3">
                  ...
                  <!--begin::Menu item-->
                  <div class="menu-item px-3 fs-5">
                    <a href="Instructor/IT_Instructor.php?view=card" class="menu-link px-3"><i
            ...
            <div class="row g-6 mb-6 g-xl-9 mb-xl-9">
              ...
              <?php
                  ...
                  if ($view == 'card') {
                      include 'IT_InstructorViewCard.php';
                  } elseif ($view == 'list') {
                      include 'IT_InstructorViewList.php';
                  } else {
                      include 'IT_InstructorViewCard.php';
                  }
              ?>
